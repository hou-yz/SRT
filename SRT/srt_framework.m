...
% 
% save('.\experiments\C_qos_0.1_10.mat','multis','srt_Es_means','ref_Es_means','srt_unsatisfied','srt_unsatisfied')
% plot(multis,srt_Es_means(1,:).*(1-srt_unsatisfied),'r',multis,srt_Es_means(2,:).*(1-srt_unsatisfied),'r--o',multis,ref_Es_means.*(1-ref_unsatisfied),'g');
