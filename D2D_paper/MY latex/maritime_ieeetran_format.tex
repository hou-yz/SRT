...
\begin{abstract}
 ...
 To solve the NP-complete problem, we develop a 3-step progressive algorithm, which only requires polynomial computational complexity. Simulation results demonstrate that the proposed scheme significantly reduces the energy consumption by up to 71\% over existing methods. 
