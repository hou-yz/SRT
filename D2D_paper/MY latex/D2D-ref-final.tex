...
\uppercase{Yunzhong Hou}\authorrefmark{1}, \\
...
\corresp{Corresponding author: Te Wei (e-mail: wei-t14@mails.tsinghua.edu.cn).}
...
%Moreover, the reference method can only meet the QoS constraint of 27Gbits/user while our proposed method can serve as much as 80Gbits/user.
